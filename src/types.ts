...
export type ConstType = {
  ...
  MAGIC_ICEBALL_FREEZE_ENEMY_MAX_TIME: number
  ...
  PARTICLE_EXPLOSION_ICEBALL_SIZE: number

  PARTICLE_EXPLOSION_ENEMY_COLOR: RGBType
  PARTICLE_EXPLOSION_MAGIC_FIREBALL_COLOR: RGBType
  PARTICLE_EXPLOSION_MAGIC_ICEBALL_COLOR: RGBType
}
