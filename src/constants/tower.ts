...
export const TOWER_RED_UPGRADE = {
  PROFIT_SELL: [80, 110, 190, 420, 1200, 2880],
  DAMAGE: [100, 140, 190, 250, 320, 450],
  COST: [100, 150, 250, 500, 1300, 3000],
  INFLUENCE_AREA: [150, 180, 220, 300, 400, 550],
} as const

export const TOWER_YELLOW_UPGRADE = {
